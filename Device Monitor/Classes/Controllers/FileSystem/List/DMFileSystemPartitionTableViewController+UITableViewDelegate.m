...
@implementation DMFileSystemPartitionTableViewController( UITableViewDelegate )

- ( void )tableView: ( UITableView * )tableView didSelectRowAtIndexPath: ( NSIndexPath * )indexPath
{
    DMFileSystemPartitionTableViewCell      * cell;
    DMFileSystemFileListTableViewController * controller;
    UIAlertView                             * alert;
    
    cell = ( DMFileSystemPartitionTableViewCell * )[ tableView cellForRowAtIndexPath: indexPath ];
    ...
    {
        [ [ DMPreferences sharedInstance ] setActiveDisk: cell.partition.mountedFS ];
        
        controller = [ [ DMFileSystemFileListTableViewController alloc ] initWithPath: cell.partition.mountPoint ];
    }
